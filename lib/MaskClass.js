...
var MaskGuide = function () {
    ...
    _createClass(MaskGuide, [{
        ...
        value: function setMaskBtnNode() {
            ...
            var refreshMask = throttle(function () {
                // console.log('resize');

                if (_this2.count == 0 && _this2.guides[0].intro) {
                    _this2.introStart();
                }
                if (!_this2.guides[0].intro || _this2.count > 0) {
                    _this2.maskStart(_this2.guides[_this2.count]);
                }
                // console.log('==');
            }, 50);
            ...
            this.skip = function (e) {
                ...
                clearEvent();
                _this2.maskNode.style.display = "none";
            };
            ...
            this.next = function (e) {
                _this2.options.isFocus && _this2.maskBtnNextNode.focus();
                if (_this2.guides[0].intro) _this2.intro = true;
                ...
                _this2.count++;
                if (_this2.guides[_this2.count]) {
                    _this2.maskBtnNextNode.innerHTML = 'Next→';
                    _this2.maskBtnBeforeNode.style.visibility = "visible";
                    if (_this2.intro == true && _this2.count == 1) {
                        _this2.maskBtnBeforeNode.style.visibility = "hidden";
                    }
                    _this2.maskStart(_this2.guides[_this2.count]);
                    if (_this2.count === _this2.guides.length - 1) _this2.maskBtnNextNode.innerHTML = 'Done';
                } else {
                    clearEvent();
                    _this2.maskNode.style.display = "none";
                }
            ...
            this.before = function (e) {
                ...
                _this2.maskBtnNextNode.innerHTML = 'Next→';
                if (_this2.count === 0 || _this2.intro == true && _this2.count == 1) {
                    _this2.maskBtnBeforeNode.style.visibility = "hidden";
                    _this2.maskStart(_this2.guides[_this2.count]);
                } else if (_this2.count > 0) {
                    _this2.maskStart(_this2.guides[_this2.count]);
                } else {
                    _this2.count = 0;
                }
            ...
            if (this.options.isKeyboard) document.addEventListener('keydown', keyEventMKGuide);

            var remove = function remove() {
                // var elem = document.querySelector('.mask-0230');
                _this2.maskNode.parentNode.removeChild(_this2.maskNode);
            };
        }
    }, {
        key: 'maskStart',
