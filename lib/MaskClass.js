...
var MaskGuide = function () {
    ...
    _createClass(MaskGuide, [{
        ...
        value: function setMaskTip() {
            ...
            var diff = this.getAbsoluteRight + 30;

            if (diff > document.documentElement.clientWidth) {
                var move = diff - document.documentElement.clientWidth + 50;
        ...
        value: function setMaskBtnNode() {
            ...
            var refreshMaskWithContext = refreshMask.bind(this);
            ...
            this.next = function (e) {
                _this.intro = true;
                if (_this.guides[_this.count].element) {
                    // clear focus
